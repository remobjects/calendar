...
// #DASCHEMA:"R:\calendar\Calendar.daSchema"
{$HIDE H7}
{$HIDE W1}
{$HIDE W27}
{$HIDE H11}
...
type
  ...
  [System.CodeDom.Compiler.GeneratedCodeAttribute('DA LINQ TableDefinitions Generator', '6.0.54.972')]
  ...
  private 
    ...
    var f____Uid: System.String;
    method set_Uid(value: System.String);
  protected 
  ...
  public 
    ...
    [RemObjects.DataAbstract.Linq.FieldName('Uid')]
    [RemObjects.DataAbstract.Linq.DataType(RemObjects.DataAbstract.Schema.DataType.WideMemo)]
    [RemObjects.DataAbstract.Linq.LogChanges]
    property Uid: System.String read f____Uid write set_Uid; virtual;
  end;
...
begin
  ...
  v____new.f____Uid := self.f____Uid;
  exit(v____new);
end;
...
method Events.set_Uid(value: System.String);
begin
  if (System.Collections.Generic.Comparer<System.String>.Default.Compare(self.f____Uid, value) <> 0) then begin
    self.OnPropertyChanging('Uid');
    f____Uid := value;
    self.OnPropertyChanged('Uid');
  end;
end;
